...
We can choose between invoking the BSOD functionality (Code 0x002) or assigning the token to each open cmd.exe and powershell.exe process
System (Code 0x011).

![alt text](https://github.com/dottorvenom/noMimikatz/blob/main/img/2.PNG)

You can integrate other IOCTL code by referring to
'''
